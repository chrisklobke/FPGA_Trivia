...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../finalproject_trivia.sopcinfo
...
# Design Name 
# setting SOPC_NAME is finalproject_trivia
SOPC_NAME := finalproject_trivia
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x4043060
SOPC_SYSID_FLAG += --sidp=0x4043060
ELF_PATCH_FLAG  += --sidp 0x4043060

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1667338681
SOPC_SYSID_FLAG += --timestamp=1667338681
ELF_PATCH_FLAG  += --timestamp 1667338681
